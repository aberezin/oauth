package com.vetonomics.app.config;

import com.vetonomics.app.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.vetonomics.app.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.vetonomics.app.repository.search")
